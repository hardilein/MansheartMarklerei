    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
      <div class="panel info">
        <header>
          ...
          <form method="post" action="admin_allprodukts.php">
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Produkte Suchen" title="Type in a name">
                    ...
                    -->
                      <!-- NICHT ERLAUBT???-->
                        ...
                        <?php
                        $mysqli = new mysqli("localhost", "root", "My10211890", "immomaster");
                        if($mysqli->connect_errno){
                          echo "Failed connect(".$mysqli->connect_errno.")".$mysqli->connect_error;
                        }

                        $query = $mysqli->query("select id, productname, description, purchaseprice, livingspace, room, yearofconstruction, floors, cellar, photo from product");
                        while($row = $query->fetch_assoc()){
                          ...
                          <td><?php echo $row['livingspace'] ?></td>
                          <td><?php echo $row['room'] ?></td>
                          <td><?php echo $row['yearofconstruction'] ?></td>
                          <td><?php echo $row['floors'] ?></td>
                          <td><?php echo $row['cellar'] ?></td>
